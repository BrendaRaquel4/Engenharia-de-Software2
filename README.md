...
pip install pytest
.\venv\Scripts\activate.bat  # Ativar para windows # (faz sempre que for começar a trabalhar). 
deactivate (faz quando terminar ou quiser mudar de projeto). # Desativar ambiente virtual
